...
agentops.json                      # schedule + worker block (deploy signal)
```
...
polls). See [project configuration](../project-config.md) and
...
write the tag into `agentops.json`'s `worker.image`. ConfigSync + the gateway's
...
| File                                                                             | Role                                    |
| -------------------------------------------------------------------------------- | --------------------------------------- |
| [agentops.json](./agentops.json)                                                 | Continuous agent + worker image/secrets |
